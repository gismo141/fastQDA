...
# Project:  fastQDA.pro
# Template: app
# Command: /Users/michaelriedel/Qt/5.3/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 -o Makefile fastQDA.pro
#############################################################################
...
Makefile: fastQDA.pro ../../Qt/5.3/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.3/clang_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 -o Makefile fastQDA.pro
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_codeSettings.cpp moc_fastqda.cpp moc_mainWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_codeSettings.cpp moc_fastqda.cpp moc_mainWidget.cpp
